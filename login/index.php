...
<div class="container">
    ...
    <div class="row justify-content-md-center">
        <div class="col-md-6">
            <div class="card border-primary bg-ligt mb-3"  >
                <div class="card-header"><h1 class="text-primary"  align="center">Login</h1></div>
                <div class="card-body" align="center">
                    <form method="post">
                        <div class="form-group"><br>
                            <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="<?php if (isset($email)){ echo $email;} ?>" autofocus required>
                        ...
                        <button type="submit" value="signin" name="signin" class="btn btn-primary">Login</button>
                        <br><br>
                        <p class="text-muted">New to DealRajaDeal ?<a href="../register/" > <strong>Register</strong></a> Here</p>
                    </form>
                </div>
            </div>
        </div>
